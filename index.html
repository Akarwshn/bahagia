...
<head>
  ...
  <title>Eren & Aay | Undangan Pernikahan</title>
...
<!-- popup start -->
<div class="d-none">
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" id="klikmodal">
    Launch demo modal
  </button>
</div>
      ...
      <div class="modal-body bg-wakwak p-0">
        <div class="row justify-content-center mt-0 text-center h-100" id="front-image-container">
          ...
          <div class="flex col-md-6 col-12 mt-auto mb-auto" id="front-text">
            ...
            <h1 class="font-dancing fs-60">Eren Priza <br/>&<br /> Muhammad Ziaul Haq</h1>
            <small class="mt-3">Sabtu, 5 Juli 2025</small>
            <hr class="border-secondary w-50 mx-auto" />
            <p class="mb-1">Kepada Bapak/Ibu/Saudara/i</p>
            <p class="mb-2 mt-2"><span class="fw-semibold h4" id="nama">Tamu Undangan</span></p>
...
<!-- SCRIPT UNTUK AMBIL NAMA TAMU DARI URL -->
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (namaTamu) {
      namaSpan.textContent = decodeURIComponent(namaTamu.replace(/\+/g, ' '));
    } else {
      namaSpan.textContent = "Tamu Undangan";
    }
  });
</script>
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-12 mt-5">
            The Wedding of
            <h1 class="font-dancing fs-60">Eren & Aay</h1>
    ...
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1100">
          ...
          <h1 class="font-dancing text-dark fs-45">Eren Priza</h1>
          <p class="m-0 p-0">Putri Ke-5</p>
          <p class="m-0 p-0">Bapak Boy Hatta Tirayoh & Ibu Eliyanah</p>
        </div>
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          ...
          <h1 class="font-dancing text-dark fs-45">Muhammad Ziaul Haq</h1>
          <p class="m-0 p-0">Putra Ke-2</p>
          <p class="m-0 p-0">Bapak Alm. Hj Jamaludin & Ibu Hj. Istiqomah</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          <div class="card p-3 shadow bg-fee">
            ...
            <p class="fw-bold p-0 m-0">Sabtu, 5 Juli 2025</p>
            <p class="m-0 p-0">Pukul 09.00 WIB</p>
            <p class="m-0 p-0">Saat acara akad diharapkan untuk kondusif menjaga kekhidmatan dan kekhusyuan seluruh prosesi</p>
          </div>
        </div>
        <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="750">
          <div class="card p-3 shadow bg-fee">
            ...
            <p class="m-0 p-0">Merupakan suatu kebahagiaan dan kehormatan bagi kami, apabila Bapak/Ibu/Saudara/i, berkenan hadir dan memberikan do'a restu kepada kedua mempelai..</p>
          </div>
        </div>
        <div class="col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          ...
          <p class="text-white">
            Jln. Abadi Rt.02/03 Kel. Kebon Besar, Kec. Batuceper, Kota Tangerang (Aula Paud Haya Bina Insani)
          </p>
          <a href="https://maps.app.goo.gl/pauNmAkF5Bc6YKZV7" target="_blank"
          ...
          <div style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%;">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.4827706499564!2d106.6754105!3d-6.1598182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f908af3c5c21%3A0x2e542bf731a232fd!2sPAUD%20Haya%20Bina%20Insani!5e0!3m2!1sen!2sid!4v1714287244891!5m2!1sen!2sid" 
      ...
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-6 mb-3 blur" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          <div class="card bg-fee rounded-3 shadow p-3">
            ...
            <hr />
            <p><span><input type="text" value="901677239020" class="bg-fee norek" id="rek1" readonly /></span> a/n       Eren Priza</p>
            <div>
      ...
      <div class="row text-center justify-content-center">
        <div class="col-lg-9 col-md-11 col-12">
          ...
          <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1250">
            <h1 class="font-dancing fs-60">Eren Priza</h1>
            <h1 class="font-dancing fs-60">&</h1>
            <h1 class="font-dancing fs-60">Muhammad Ziaul Haq</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="bg-kulit">
    <div class="container pb-5">
      <div class="row text-center">
        <div class="col-12">
          <small class="p-0 m-0">
            Jangan lupa di follow yaa=> <a target="_blank" href="https://www.instagram.com/akarwshn_?igsh=a285YXpjMzFza3Nr ">@akarwshn_</a> | :D
          </small>
        </div>
      </div>
    </div>
